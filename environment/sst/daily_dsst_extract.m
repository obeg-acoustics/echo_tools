function [daily_sst, lon_sst, lat_sst, time_sst, distance_sst] = daily_dsst_extract(echogram, file, day, daily_sst, lon_sst, lat_sst, time_sst, distance_sst,daynight)
