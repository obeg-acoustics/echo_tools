function [daily_poc, lon_poc, lat_poc, time_poc, distance_poc] = daily_poc_extract(echogram, file, day, daily_poc, lon_poc, lat_poc, time_poc, distance_poc)
...
distance_poc = [distance_poc; distance_day'];
