function [weekly_mld, lon_mld, lat_mld, time_mld, distance_mld] = weekly_dvy_extract(echogram, file, day, weekly_mld, lon_mld, lat_mld, time_mld, distance_mld)
...
dy  = deg2km(distance(v_lat(:,3:end),v_lon(:,3:end),v_lat(:,1:end-2),v_lon(:,1:end-2)));
dvy = dv./dy;
...
% Extraction of dvy
a = interp2(lon, lat(2:end-1), dvy', lon_day, lat_day);
