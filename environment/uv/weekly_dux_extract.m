function [weekly_mld, lon_mld, lat_mld, time_mld, distance_mld] = weekly_dux_extract(echogram, file, day, weekly_mld, lon_mld, lat_mld, time_mld, distance_mld)
...
dx  = deg2km(distance(u_lat(3:end,:),u_lon(3:end,:),u_lat(1:end-2,:),u_lon(1:end-2,:)));
dux = du./dx;
...
% Extraction of dux
a = interp2(lon(2:end-1), lat, dux', lon_day, lat_day);
