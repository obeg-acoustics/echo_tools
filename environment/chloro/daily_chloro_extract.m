function [daily_chl, lon_chloro, lat_chloro, time_chl, distance_chl] = daily_chloro_extract(echogram, file, day, daily_chl, lon_chloro, lat_chloro, time_chl, distance_chl)
...
distance_chl = [distance_chl; distance_day'];
